...
func (h header) MarshalJSON() ([]byte, error) {
	type header struct {
		...
		RbxEpoch        math.HexOrDecimal64       `json:rbxEpoch"`
		EpochTx         math.HexOrDecimal64       `json:"epochTx"`
		Rbx             math.HexOrDecimal64       `json:"rbx"`
		Supply          *math.HexOrDecimal256     `json:"supply"`
	...
	enc.Epoch = math.HexOrDecimal64(h.Epoch)
	enc.EpochTx = math.HexOrDecimal64(h.EpochTx)
	enc.Rbx = math.HexOrDecimal64(h.Rbx)
	enc.RbxEpoch = math.HexOrDecimal64(h.RbxEpoch)
	enc.Supply = (*math.HexOrDecimal256)(h.Supply)
...
func (h *header) UnmarshalJSON(input []byte) error {
	...
	if dec.EpochTx != nil {
		h.EpochTx = uint64(*dec.EpochTx)
	}
	if dec.Rbx != nil {
		h.Rbx = uint64(*dec.Rbx)
	}
	if dec.RbxEpoch != nil {
		h.RbxEpoch = uint64(*dec.RbxEpoch)
	}
	if dec.Supply != nil {
