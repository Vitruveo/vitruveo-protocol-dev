...
func (s *BlockChainAPI) GetBalance(ctx context.Context, address common.Address, blockNrOrHash rpc.BlockNumberOrHash) (*hexutil.Big, error) {
	...
	rebasedBalance := rebase.GetRebasedAmount(balance, header.Rbx)
	return (*hexutil.Big)(rebasedBalance), state.Error()
}
...
func doCall(ctx context.Context, b Backend, args TransactionArgs, state *state.StateDB, header *types.Header, overrides *StateOverride, blockOverrides *BlockOverrides, timeout time.Duration, globalGasCap uint64) (*core.ExecutionResult, error) {
	...
	result, err := core.ApplyMessage(3, evm, msg, gp)
...
func RPCMarshalHeader(head *types.Header) map[string]interface{} {
	result := map[string]interface{}{
		...
		"epochTx":  hexutil.Uint64(head.EpochTx),
...
func AccessList(ctx context.Context, b Backend, blockNrOrHash rpc.BlockNumberOrHash, args TransactionArgs) (acl types.AccessList, gasUsed uint64, vmErr error, err error) {
	...
	for {
		...
		res, err := core.ApplyMessage(4, vmenv, msg, new(core.GasPool).AddGas(msg.GasLimit))
		if err != nil {
