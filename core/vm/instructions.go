...
func opBalance(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, error) {
	...
	rebasedBalance := rebase.GetRebasedAmount(balance, interpreter.evm.Context.Rbx)
	slot.SetFromBig(rebasedBalance)
	return nil, nil
}
...
func opSelfdestruct(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, error) {
	...
	// Don't need rebased balance here because the entire balanace is being transferred
